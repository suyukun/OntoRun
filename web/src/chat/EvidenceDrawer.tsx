...
export default function EvidenceDrawer({ open, auditId, onClose }: Props) {
  // ESC 关闭（§6.3）
  useEffect(() => {
    if (!open) return;
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: '#fff' }}>
      ...
      >
        <span style={{ flex: 1, fontSize: 12, lineHeight: '20px', color: RISK_COLORS.textFaint }}>{EVIDENCE_DETAIL.footer}</span>
