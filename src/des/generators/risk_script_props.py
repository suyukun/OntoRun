...
- 剧本道具（§七）：天晟集团——安平银行 48 亿（8.0%）+安平证券 22 亿（5.5%）+安平资管 16.4 亿
  ...
  F3 修复：瑞华敞口重分布到多家附属机构（安平银行 40 亿 + 安平证券 20 亿 + 安平资管 15.2 亿，
  单家均 < 行内限额/参考线，杜绝「75.2 亿单挂一家却断言单看均安全」的算术矛盾）。
...
# F3 修复：瑞华敞口重分布到多家附属机构（单家 < 行内限额 60 亿）——原 75.2 亿全挂安平银行
# （>行内限额 60 亿），与「单看均安全」结论自相矛盾（算术矛盾+双重病根：种子全挂一家+模板写死均安全）。
# 现分布：安平银行 40 亿（6.7%，行内限额 60 亿内）+ 安平证券 20 亿（5.0%，参考线 5.5% 内）
# + 安平资管 15.2 亿（7.6%，参考线 8.2% 内）= 归集 75.2 亿 → 9.4% 黄不变（§七 第 6 幕闭环案例）。
PROP_CREDITS = (
    ...
    ("SC-2026-900005", "CID-2026-90000003", "瑞华实业有限公司", "瑞华能源集团有限公司", "安平银行", 400000.0, 40.0),
    ("SC-2026-900006", "CID-2026-90000003", "瑞华实业有限公司", "瑞华能源集团有限公司", "安平证券", 200000.0, 20.0),
    ("SC-2026-900007", "CID-2026-90000003", "瑞华实业有限公司", "瑞华能源集团有限公司", "安平资产管理", 152000.0, 15.2),
)
