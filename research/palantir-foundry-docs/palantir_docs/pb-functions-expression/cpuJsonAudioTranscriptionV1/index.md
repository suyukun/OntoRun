来源: https://palantir.com/docs/zh/foundry/pb-functions-expression/cpuJsonAudioTranscriptionV1/
...
- 媒体引用- 包含媒体集中音频文件的媒体引用的列。表达式<媒体引用>
- 非必填语言- 要检测的输入文件语言。如果未提供语言，将从音频的前30秒推断。枚举<南非语, 阿尔巴尼亚语, 阿姆哈拉语, 阿拉伯语, 亚美尼亚语, 阿萨姆语, 阿塞拜疆语, 巴什基尔语, 巴斯克语, 白俄罗斯语, 以及更多...>
输出类型:字符串
