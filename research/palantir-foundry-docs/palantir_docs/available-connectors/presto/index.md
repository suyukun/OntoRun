来源: https://palantir.com/docs/zh/foundry/available-connectors/presto/
...
Presto连接器是一个Palantir提供的驱动程序连接器。该驱动程序的官方文档可以在这里 ↗找到。
...
| 域 | 必需 |
| --- | --- |
| <Server>:<Port> | 始终。服务器和端口连接属性。默认Port=8080 |
