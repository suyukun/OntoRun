来源: https://palantir.com/docs/zh/foundry/available-connectors/microsoft-planner/
...
Microsoft Planner 连接器是一个由 Palantir 提供的驱动程序连接器。该驱动程序的官方文档可以在这里 ↗找到。
...
| <KerberosServiceKDC>:88 | 仅当AuthScheme=Negotiate且 Kerberos 拓扑使用多个域 |
